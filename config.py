...
class DefaultConfigs(object):
    ...
    # scan_type = 'Spectral-priority'  #Spectral-priority  #Spatial-priority  #Cross spectral-spatial #Cross spatial-spectral     Parallel spectral-spatial #spatial-spectral   spectral-spatial   spectral  spatial
    scan_type = 'Parallel spectral-spatial'
    k_group = 4 #Spectral-priority
    pos = False
    cls = False
    # 3DConv parameters
    conv3D_channel = 4
    conv3D_kernel = (1, 1, 1)#(3, 5, 5)
